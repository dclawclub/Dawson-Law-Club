...
const Events = (props) => {
  return (
    <div className="events-container">
      <Helmet>
        <title>Events - Dawson Law Club</title>
        <meta property="og:title" content="Events - Dawson Law Club" />
      </Helmet>
      <header data-role="Header" className="events-header">
        ...
        <div className="events-icon-group">
          ...
          >
            <svg viewBox="0 0 877.7142857142857 1024" className="events-icon">
      ...
      <footer className="events-footer">
        <span className="events-text4">© 2023 DLC, All Rights Reserved.</span>
      </footer>
    </div>
  )
}
